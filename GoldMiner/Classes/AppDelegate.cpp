...
bool AppDelegate::applicationDidFinishLaunching() {
	...
	char totalFrames2 = 7;
	char frameName2[20];
	Animation* eatAnimation = Animation::create();

	for (int i = 0; i < totalFrames2; i++)
	{
		sprintf(frameName2, "gem-mouse-%d.png", i);
		eatAnimation->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName(frameName2));
	}
	eatAnimation->setDelayPerUnit(0.1);
	AnimationCache::getInstance()->addAnimation(eatAnimation, "eatAnimation");
